...
-- Column names match the CSV headers exactly for easy import.
...
ALTER TABLE cars ADD COLUMN IF NOT EXISTS model_name            TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS series                TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS prod_from             TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS prod_to               TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS frame_short           TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS year_month            TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS plantcity            TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS plantcompanyname    TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS plantcountry         TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS plantstate           TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS displacementcc       INTEGER;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS displacementci       TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS displacementl        TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS engineconfiguration  TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS enginecylinders      INTEGER;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS enginehp             INTEGER;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS enginehp_to          INTEGER;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS enginemanufacturer   TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS enginemodel          TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS modelyear            INTEGER;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS doors                 INTEGER;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS airbaglocfront     TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS transmissionspeeds   TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS transmissionstyle    TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS searched_vin          TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS vin_star              TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS chars_bottom          TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS additionalerrortext TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS possiblevalues       TEXT;
ALTER TABLE cars ADD COLUMN IF NOT EXISTS suggestedvin         TEXT;
...
ALTER TABLE cars ADD COLUMN IF NOT EXISTS make_1       TEXT;
...
-- If migrating from an older schema where columns had different names,
-- rename them to match the CSV convention (DO blocks skip if already renamed).
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='cars' AND column_name='production_from')  THEN ALTER TABLE cars RENAME COLUMN production_from  TO prod_from;          END IF;
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='cars' AND column_name='production_to')    THEN ALTER TABLE cars RENAME COLUMN production_to    TO prod_to;            END IF;
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='cars' AND column_name='displacement_cid') THEN ALTER TABLE cars RENAME COLUMN displacement_cid  TO displacement_ci;    END IF;
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='cars' AND column_name='engine_make')      THEN ALTER TABLE cars RENAME COLUMN engine_make       TO engine_manufacturer;END IF;
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='cars' AND column_name='plant_company')    THEN ALTER TABLE cars RENAME COLUMN plant_company     TO plant_company_name; END IF;
...
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS plantcity            TEXT;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS plantcompanyname    TEXT;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS plantcountry         TEXT;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS plantstate           TEXT;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS displacementcc       INTEGER;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS displacementci       TEXT;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS displacementl        TEXT;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS engineconfiguration  TEXT;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS enginecylinders      INTEGER;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS enginehp             INTEGER;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS enginehp_to          INTEGER;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS enginemanufacturer   TEXT;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS enginemodel          TEXT;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS modelyear            INTEGER;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS doors                 INTEGER;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS airbaglocfront     TEXT;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS transmissionspeeds   TEXT;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS transmissionstyle    TEXT;
...
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS additionalerrortext TEXT;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS possiblevalues       TEXT;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS suggestedvin         TEXT;
ALTER TABLE vin_directory ADD COLUMN IF NOT EXISTS color_code         TEXT;
...
ALTER TABLE vin_directory  ADD COLUMN IF NOT EXISTS engine        TEXT;
ALTER TABLE vin_directory  ADD COLUMN IF NOT EXISTS transmission       TEXT;
ALTER TABLE vin_directory  ADD COLUMN IF NOT EXISTS make_1       TEXT;
ALTER TABLE vin_directory  ADD COLUMN IF NOT EXISTS model        TEXT;
ALTER TABLE vin_directory  ADD COLUMN IF NOT EXISTS trim        TEXT;
ALTER TABLE vin_directory  ADD COLUMN IF NOT EXISTS vin        TEXT;
